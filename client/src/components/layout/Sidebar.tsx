...
function SettingsGroup({
  ...
  return (
    <div className={menuEditMode ? 'rounded-lg border border-dashed border-gray-700' : ''}>
      <div className="flex items-center">
        ...
        {menuEditMode && (
          <div className="flex flex-col mr-1">
            ...
            <button
              onClick={() => moveItem(index, 1)}
              className={`p-0.5 rounded transition-colors ${index === totalItems - 1 ? 'text-gray-700 cursor-default' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
